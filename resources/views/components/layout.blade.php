...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        ...
        >
            <img src="/images/lary-icon.svg" alt="" class="mx-auto -mb-6" style="width: 145px;">

            <h5 class="text-3xl">Comment and share this Blog!</h5>
            <p class="text-sm mt-3">Promise to introduce the hidden castles of Japan.</p>
